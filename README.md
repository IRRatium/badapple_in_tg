...
| Файл | Что делает |
|---|---|
| `bot.py` | **Проигрыватель** — воспроизводит готовую анимацию Bad Apple в канале |
...
> **Где взять CHAT_ID** — перешли любое сообщение из канала боту [@userinfobot](https://t.me/userinfobot).

---

### 7. Добавить ботов в канал

Для `bot.py` — все 5 ботов должны быть администраторами канала с правами **«Публикация»** и **«Редактирование сообщений»**.
